...
const input=():CheckoutInput=>({acceptedTerms:true,requestId:randomUUID(),locale:'en',items:[{productId:21,quantity:2}],customer:{name:'Test Customer',email:'customer@example.test',phone:'+31600000000',fulfillment:'pickup',street:'',postcode:'',city:'Amsterdam',comment:''}});
