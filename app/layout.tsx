...
export const metadata:Metadata={title:{default:'Watta Sushi — Fresh sushi in Amsterdam',template:'%s | Watta Sushi'},description:'Fresh sushi and rolls delivered throughout Amsterdam. Order online or pick up at Helicopterstraat 20. Every day 14:00–21:00.'};
